...
<html>
	...
	<body>	
		<br>
		<form action="./P1/import_csv.php" method="POST">
		...
		<br>
			...
			<a href="./P1/tables.php?table=USERS"> Users Information </a><br>
			<a href="./P1/tables.php?table=EVENTS"> Events Information </a><br>
			<a href="./P1/tables.php?table=ROLES"> Role Of People in Events </a><br>
		</div>
	</body>
</html>
