...
<div id="right-col-container">
	...
	<!-- This is where we send messages, the textarea on the bottom that works with pressing enter too -->
...
<script>
	...
	$("document").ready(function(event) {
		...
		$("#right-col-container").on('submit', '#message-form', function() {
			...
			// Next we want the data to be sent to the SendingProcess.php file
			$.post("SendingProcess.php?user=<?php echo $_GET['user'];?>",
			{
