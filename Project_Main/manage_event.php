...
echo"<div class='form-container'>";
    ...
    echo"<div>";
        echo "<h1 align='center'>".$result['eventname']."</h1>";
    echo "</div><br>";

    echo"<div>";
        echo "<h2 >Total Charges for this event: ".$result['fee']."</h2>";
    echo "</div><br>";
  ...
  echo"<div>";
    echo "<h2>Members in the Event</h2>";
  ...
  echo"<div>";
    echo "<h2>Approve/Delete Request</h2>";
    $col = array("username", "email"); 
